    ...
    def __getitem__(self, index):
        ...
        if not self.use_full_frame:
            ...
            if self.downsample > 1:
                ...
                input_frames = cv2.resize(input_frames, (self.frame_size, self.frame_size), interpolation=cv2.INTER_LINEAR)
                ref_frame = cv2.resize(ref_frame, (self.frame_size, self.frame_size), interpolation=cv2.INTER_LINEAR)
