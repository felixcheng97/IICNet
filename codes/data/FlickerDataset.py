...
class FlickerDataset(Dataset):
    ...
    def __init__(self, dataset_opt):
        super(FlickerDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        for i, input_frame_path in enumerate(input_frame_paths):
            input_frame = cv2.imread(item[input_frame_path])
            frame = self.crop(input_frame, 576, 576)
